...
import 'package:flutter_boost/core/widgets/app_text_field.dart';
import 'package:flutter_boost/features/auth/controllers/auth_controller.dart';
...
void main() {
  ...
  testWidgets('T-7: App name is displayed on LoginPage', (tester) async {
    ...
    // l10n.commonAppName == 'Flutter Boost' in zh locale.
    expect(find.text('Flutter Boost'), findsOneWidget);
  });
